...
with DAG('weather_dag',
    ...
    with TaskGroup(group_id="setup_tables") as setup_tables:
        ...
        create_static_data_table= PostgresOperator(
            task_id="create_static_data_table",
        ...
        truncate_static_data_table = PostgresOperator(
            task_id="truncate_static_data_table",
            postgres_conn_id="postgres_conn",
            sql="""TRUNCATE TABLE cities;"""
        )

        static_data_s3_to_postgres= PostgresOperator(
            task_id="static_data_s3_to_postgres",
            postgres_conn_id= 'postgres_conn',
        ...
        truncate_weather_data_table = PostgresOperator(
            task_id="truncate_weather_data_table",
            postgres_conn_id="postgres_conn",
            sql="""TRUNCATE TABLE weather_data;"""
        )

        create_static_data_table >> truncate_static_data_table >> static_data_s3_to_postgres
        create_weather_data_table >> truncate_weather_data_table
    ...
    upload_joined_data_to_s3 = PythonOperator(
        task_id= 'upload_joined_data_to_s3',
    ...
    start_pipeline >> setup_tables >> is_weather_api_ready >> etl >> join_data >> upload_joined_data_to_s3 >> end_pipeline